...
The release target is **`precall` 0.2.0**, hosted by the `Okazakee/PreCall` repository and licensed Apache-2.0. The package is ESM-only and declares Node.js >=22.14.0 and Bun >=1.3.14; development remains pinned to `bun@1.3.14`.
